...
- Read:
  ...
  - [VegetationRenderGraphGpuDrivenPlan](../DetailedDocs/VegetationRenderGraphGpuDrivenPlan.md) - target cutout for removing C# preparation-job synchronization by moving visibility, admission, budgets, compaction, and indirect-args writes into RenderGraph compute passes
