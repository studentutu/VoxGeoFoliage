...
- Read:
  ...
  - [VegetationGenerationalRedesign](../DetailedDocs/VegetationGenerationalRedesign.md) - whole-system redesign proposal for the non-HZB production baseline and full replacement migration: editor-compiled representation packets, compiled pages, global render world, page/cell HLOD, active budgets, CheapTree shadow packets, shader wind, grouped indirect submission, no maintained old/new renderer split, and scalable 100k to 1M streamed forests
