...
- `Assets/Scripts/Features/Vegetation`
  - vegetation feature assemblies, Phase A authoring sync, and Phase B shell/impostor bake pipeline
- `Assets/Scripts/Features/Vegetation/Runtime/Meshes`
  - explicit native `.mesh` assets generated by the vegetation shell/impostor bake pipeline
- `Assets/Scripts/MassPlacement`
  - editor-triggered scatter utility that raycasts down onto physical ground
- `Assets/EditorTests`
  - EditMode tests (faster then playmode tests), including vegetation authoring and shell-generation coverage
- `Assets/Editor`
