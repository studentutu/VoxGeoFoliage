...
- `Packages/com.voxgeofol.vegetation/Runtime`
  ...
  - `MeshVoxelizerV1/` hosts the shared MeshVoxelizer surface/hierarchy utilities and demo used by the current Phase B shell bake path and the coarse size-4 impostor bake path
