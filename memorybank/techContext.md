...
- `Packages/com.voxgeofol.vegetation/Runtime`
  ...
  - `VoxelizerV2/` hosts the CPU/GPU voxel utilities; the production canopy and impostor bake paths now use the CPU volume + surface mesh path from this folder, including optional coplanar-face reduction through `CpuVoxelSurfaceMeshBuilder`
