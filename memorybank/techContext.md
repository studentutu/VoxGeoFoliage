...
- The current redesign authority now defines when BFS becomes worth using: only after tree-level prioritization and promoted-tree compaction, and only for promoted shell branches in `L1/L2/L3`.
